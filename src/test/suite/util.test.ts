...
suite('Util Test Suite', () => {
    ...
    test('getOffsetOfTarget.skipCharLeft', () => {
        assert.strictEqual(0, util.getOffsetOfTarget("a12a4", 4, -1, "a"));
    });

    test('getOffsetOfTarget.skipCharRight', () => {
        assert.strictEqual(3, util.getOffsetOfTarget("a12a4", 0, 1, "a"));
    });
});
